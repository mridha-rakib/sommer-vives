...
const testimonials = [
  {
    ...
    quote: 'Det føles som et helt andet samarbejde end det, vi kendte fra vores tidligere bureau. Her er der en reel kontaktperson, og vi kan mærke, at de faktisk investerer i vores hus.',
    rating: 5,
  ...
  },
  {
    ...
    quote: 'Jeg ville have noget, der var nemt og gennemsigtigt. Det er præcis, hvad jeg fik. Udbetalingerne kommer til tiden, og jeg behøver ikke jagte nogen for at få svar.',
    rating: 5,
  ...
  },
  {
    ...
    quote: 'Fra billeder til prissætning — alt var håndteret, da vi gik live. Vi havde 32 ugers udlejning i første sæson. Det er svært at bede om mere.',
    rating: 5,
