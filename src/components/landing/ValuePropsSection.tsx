  ...
  return (
    <section ref={ref} className="py-20 md:py-28 bg-muted/20 overflow-hidden">
      <div className="container mx-auto px-4 md:px-8">
        ...
        >
          <span className="text-primary font-body text-sm font-semibold tracking-[0.3em] uppercase block mb-3">
            Derfor SommerVibes
          </span>
          <h2 className="font-display text-3xl md:text-5xl font-bold text-foreground leading-tight max-w-3xl mx-auto">
            Alt du har brug for —{' '}
            <span className="text-primary italic font-normal">samlet ét sted</span>
          </h2>
        </motion.div>
